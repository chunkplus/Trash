...
//extern void computeGold(char *reference, char *idata, const unsigned int len);
extern void computeGold(char *reference, char *idata, const unsigned int len);
extern void computeGold2(int2 *reference, int2 *idata, const unsigned int len);
...
////////////////////////////////////////////////////////////////////////////////
bool runTest(const int argc, const char **argv, char *data, int2 *data_int2,
		unsigned int len) {
	...
	checkCudaErrors(
			cudaMemcpy(data_int2, d_data_int2, mem_size_int2,
