...
void myStreamCallback(cudaStream_t stream, cudaError_t status, void *data) {
...
int main(int argc, char **argv) {
	...
	workloads = (heterogeneous_workload *) malloc(
			N_workloads * sizeof(heterogeneous_workload));
	;
